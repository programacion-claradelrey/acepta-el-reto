...
public class Problema100Kaprekar {
	...
	// En este problema se ha optado por manejar los números como cadenas o
	// arrays de caracteres a la hora de ordenar sus dígitos. Aunque se puede
	// hacer con dígitos, usar String.toCharArray() permite manejar los ceros
	// a la izquierda más fácilmente.
