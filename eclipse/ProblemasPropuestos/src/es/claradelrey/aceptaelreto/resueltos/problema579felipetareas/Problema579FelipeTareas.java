package es.claradelrey.aceptaelreto.resueltos.problema579felipetareas;
...
public class Problema579FelipeTareas {
	...
	private static class Tarea implements Comparable<Tarea> {
		...
		public int compareTo(Tarea o) {
			...
			// quedando:
			// int comparacion = -Integer.compare(this.prioridad, o.prioridad)
			...
			// Si no tienen la misma prioridad devolvemos el valor de la comparación
			// realizada antes.
			return comparacion;
		}
